...
[43]  À ce propos, Alexandre Cioranescu (*ibid.*, p.282) prend l'exemple des crinières que l'on doit transformer en perruques pour
            être en phase avec les goûts français. Il évoque aussi le fait que tous les rapports avant le mariage sont atténués par les adaptateurs.
